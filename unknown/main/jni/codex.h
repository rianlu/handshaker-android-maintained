...
/****************************ALIAS***********************************/
#define aes_key_setup kysp_1
#define aes_encrypt et_2
#define aes_decrypt dt_3
#define aes_encrypt_cbc etcc_4
#define aes_decrypt_cbc dtcc_5
#define aes_encrypt_cbc_mac etccmc_6
#define increment_iv itiv_7
#define aes_encrypt_ctr etcr_8
#define aes_decrypt_ctr dtcr_9
#define aes_encrypt_ccm etcm_10
#define aes_decrypt_ccm dtcm_11
#define aes_test tt_12
#define aes_ecb_test ebtt_13
#define aes_cbc_test cctt_14
#define aes_ctr_test crtt_15
#define aes_ccm_test cmtt_16
